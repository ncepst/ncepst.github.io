...
で定義される量です。 $$\omega_{\mathrm{0}}$$ と蓄積エネルギーが減衰する時定数τ  に比例します。  
...
・マッチングQ：インピーダンス整合回路そのものが持つQ　→ 整合回路の「形状・比率」から決まる  
    ⇒　「その整合回路はどれくらいエネルギーを循環させているか」  
・マッチング回路のQ：マッチング回路の設計に用いる。マッチング回路の鋭さを表すQ (マッチングQと同義だが、理想素子で考えた設計パラメータ)
