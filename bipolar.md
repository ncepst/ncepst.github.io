...
BJTとMOSトランジスタは、増幅素子として共通の役割を持つが、  
電流生成機構・小信号特性・設計自由度・集積適性において本質的な差がある。

本稿では、**MOSを基準にした場合のBJTのメリット・デメリット**が  
どこから来るのかを、式と設計観点から整理する。
...
$$
V_T = \frac{kT}{q} \approx 26\ \text{mV @ 300K}
$$
...
$$
g_m = \frac{\partial I_D}{\partial V_{GS}} = \frac{2I_D}{V_{ov}}
$$
